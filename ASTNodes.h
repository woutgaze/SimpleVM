...
#define PRIM_INT_SMALLER_OR_EQUAL_NODE 51
...
typedef struct ArithmeticLoopNode ArithmeticLoopNode;
...
typedef struct JumpFalseNode JumpFalseNode;
...
typedef struct PrimIntSmallerOrEqualNode PrimIntSmallerOrEqualNode;
...
struct PrimIntSmallerOrEqualNode {
	Node super;
	Node * left;
	Node * right;
};
